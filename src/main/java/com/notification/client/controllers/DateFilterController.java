...
public class DateFilterController {
    ...
    public void showDialog() {
        ...
        BorderPane pane;
        try {
            pane = (BorderPane) FXMLLoader.load(getClass().getClassLoader().getResource("fxmls/DateFilterController.fxml"));
    ...
    public void confirm() {
        ...
        Date newFromValue = EmailStatisticController.from;
        Date newToValue = EmailStatisticController.to;
        ...
        List<Message> messages = messageDAOService.getMessagesFromTo(newFromValue, newToValue);
    ...
    private List<Message> getActiveMessages(Date from, Date to) {
        return messageDAOService.getMessagesFromTo(from, to);
    }
